  ...
  if (idioma == "por") {
    return (
      <>
        ...
        <p>
          O investidor paga taza de gás apenas ao colocar e retirar seus tokens
          na Autocompra. As taxas cobradas pelas compras diárias e automáticas
          sao pagas pelo AMT.
        </p>
        <p>
          Na prática, a medida que a quantidade de AMT aumenta, seus
          rendimientos, mais AMT sao comprados, e assim por diante, de modo que
          funciona como um juro composto.
        </p>
        <p>
...
export const textoBotonesBlancos = {
  por: {
    market: {
      titulo: "Market",
