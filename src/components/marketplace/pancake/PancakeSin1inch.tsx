...
const PancakeSin1inch: React.FC<PancakeSwapInterface> = ({ setActivePage }) => {
  ...
  const handleButtonClick = () => {
    window.open("https://pancakeswap.finance/swap?outputCurrency=0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c&inputCurrency=0x6Ae0A238a6f51Df8eEe084B1756A54dD8a8E85d3", '_blank');
  };
  return (
    <div
    ...
    >
      ...
      <button style={{justifyContent:"center", alignItems:"center", display:"flex"}} onClick={handleButtonClick}><img style={{maxHeight:"25px", maxWidth:"25px"}} src="logoPancake.png" />Pancakeswap</button>
